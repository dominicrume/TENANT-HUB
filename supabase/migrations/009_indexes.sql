...
-- Disable transactions for CONCURRENTLY
COMMIT;

-- Tenants: filtering by active/archived is done on almost every query
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_tenants_active_archived 
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_stamp_queue_status 
